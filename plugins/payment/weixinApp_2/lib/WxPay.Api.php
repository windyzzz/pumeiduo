	...
	*/
	...
	private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
	{
		...
		if(WxPayConfig::CURL_PROXY_HOST != "0.0.0.0"
			...
			curl_setopt($ch,CURLOPT_PROXY, dirname(__FILE__).'/'.WxPayConfig::CURL_PROXY_HOST);
			curl_setopt($ch,CURLOPT_PROXYPORT, dirname(__FILE__).'/'.WxPayConfig::CURL_PROXY_PORT);
		}
