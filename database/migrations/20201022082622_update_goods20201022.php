...
class UpdateGoods20201022 extends Migrator
{
    ...
    public function change()
    {
        $this->table('goods')
            ...
            ->addColumn('applet_on_sale', 'integer', ['default' => 0, 'limit' => \Phinx\Db\Adapter\MysqlAdapter::INT_TINY, 'comment' =>'小程序上架状态1'])
            ->addColumn('applet_on_sale2', 'integer', ['default' => 0, 'limit' => \Phinx\Db\Adapter\MysqlAdapter::INT_TINY, 'comment' =>'小程序上架状态2'])
