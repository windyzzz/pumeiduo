...
class Index extends Base
{
    public function index()
    {
        ...
        $hot_goods = $hot_cate = $cateList = $recommend_goods = [];
    ...
    {
        $list = M('region2')->field('id as v , name as n')->where('parent_id', 0)->select();
        foreach ($list as $k => $v) {
            $list[$k]['c'] = $this->_getList($v['v']);
        }
    ...
    {
        $list = M('region2')->field('id as v , name as n')->where('parent_id', $id)->select();
    ...
    public function qr_code()
    {
        ...
        if ($valid_date && false !== strpos($url, 'weixin.qq.com')) {
    ...
    public function truncate_tables()
    {
        ...
        $table = ['tp_admin', 'tp_config', 'tp_region', 'tp_system_module', 'tp_admin_role', 'tp_system_menu', 'tp_article_cat', 'tp_wx_user'];
