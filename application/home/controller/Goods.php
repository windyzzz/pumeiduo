...
class Goods
{
    ...
    public function getShareImage()
    {
        ...
        $filename = 'public/images/qrcode/goods/goods_'.$user_id.'.png';
    ...
    private function scerweima($user_id,$goods_id)
    {
        ...
        $url = $baseUrl.'/#/goods/goods_detail?goods_id='.$goods_id.'&invite='.$user_id;
    ...
    public function getGoodsShareInfo()
    {
        $goods_id = I('goods_id/d', 0);
        if (!$goods_id) {
            return json(['status' => -1, 'msg' => '非法请求，请求参数不全。', 'result' => null]);
        }
        $goods = M('Goods')
            ->field('goods_name,goods_remark,original_img,is_on_sale,is_virtual,virtual_indate')
    ...
    public function getNewGoods()
    {
        ...
        return json(['status' => 1, 'msg' => 'success', 'result' => $list, 'page' => $page]);
    }
    ...
    public function getRecommendGoods()
    {
        ...
        return json(['status' => $status, 'msg' => 'success', 'result' => $return]);
    }
