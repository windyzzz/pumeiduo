...
class Cron extends Controller
{
    ...
    function auto_on_out()
    {
        ...
        M('goods')->where(array('is_area_show|is_on_sale2|store_count' => 0))->data(array('is_on_sale' => 0, 'applet_on_sale' => 1))->save();
        // 代理商商品
        M('goods')->where(array('is_agent' => 1, 'is_on_sale' => 1, 'store_count' => array('gt', 0), 'applet_on_time' => array('elt', NOW_TIME), 'applet_out_time' => array('gt', NOW_TIME)))->data(array('applet_on_sale' => 1))->save();
        M('goods')->where(array('is_agent' => 1, 'applet_on_sale' => 1, 'applet_out_time' => array('elt', NOW_TIME)))->data(array('applet_on_sale' => 0))->save();
    }
