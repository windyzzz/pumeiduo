...
use app\admin\model\Region2 as Region2Model;
use app\admin\model\SpecialRegion as SpecialRegionModel;
...
class Cron1 extends Controller
{
     ...
     * @return string
     */
    public function differRegion(Request $request)
    {
        set_time_limit(0);      // 执行时间无限
        ini_set('memory_limit', '-1');    // 内存无限
        ...
        // 本地一级地区
        $localRegion1 = M('region2')->where(['level' => 0])->limit($offset, $length)->field('id, name')->select();
        // 供应链一级地区
