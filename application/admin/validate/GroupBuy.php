...
class GroupBuy extends Validate
{
    ...
    protected $rule = [
        ...
        ['group_goods_num', 'require|number|checkGroupGoodsNum'],
        ['virtual_num', 'number'],
        ['start_time', 'require'],
    ...
    protected $message = [
        ...
        'group_goods_num.require' => '请填写参加起团数量',
        'goods_num.number' => '团购数量必须为数字',
        'group_goods_num.number' => '起购数量必须为数字',
        'group_goods_num.checkGroupGoodsNum' => '团购数量必须要是起购数量的倍数',
     ...
     * @return bool|string
     */
    protected function checkGroupGoodsNum($value, $rule, $data)
    {
        return is_float($data['goods_num'] / $value) ? false : true;
    }
