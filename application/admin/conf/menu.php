...
return [
    ...
    'shop' => ['name' => '商城', 'child' => [
        ...
        ['name' => '商学院', 'child' => [
            ['name' => '配置', 'act' => 'config', 'op' => 'school.module'],
            ['name' => '课程统计', 'act' => 'courseList', 'op' => 'school.article'],
            ['name' => '公司简介', 'act' => 'module1', 'op' => 'school.module'],
            ['name' => '产品专区', 'act' => 'module2', 'op' => 'school.module'],
            ['name' => '社群营销', 'act' => 'module3', 'op' => 'school.module'],
            ['name' => '分阶培训', 'act' => 'module4', 'op' => 'school.module'],
            ['name' => '在线培训', 'act' => 'module5', 'op' => 'school.module'],
            ['name' => '当前热点', 'act' => 'module9', 'op' => 'school.module'],
            ['name' => '素材专区', 'act' => 'module6', 'op' => 'school.module'],
