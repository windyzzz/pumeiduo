...
//            return ['status' => -1, 'msg' => '密码格式为6-20位字母数字组合'];
    ...
    {
        $sql = 'SELECT og.*,g.commission,g.original_img,og.use_integral,og.give_integral,rg.status,g.zone FROM __PREFIX__order_goods og LEFT JOIN __PREFIX__goods g ON g.goods_id = og.goods_id LEFT JOIN __PREFIX__return_goods rg ON rg.rec_id = og.rec_id WHERE og.order_id = :order_id';
